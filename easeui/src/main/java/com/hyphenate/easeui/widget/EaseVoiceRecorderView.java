...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        micImages = new Drawable[] { getResources().getDrawable(R.drawable.ease_record_animate_01e),
                getResources().getDrawable(R.drawable.ease_record_animate_02e),
                getResources().getDrawable(R.drawable.ease_record_animate_03e),
                getResources().getDrawable(R.drawable.ease_record_animate_04e),
                getResources().getDrawable(R.drawable.ease_record_animate_05e),
                getResources().getDrawable(R.drawable.ease_record_animate_06e),
                getResources().getDrawable(R.drawable.ease_record_animate_07e),
                getResources().getDrawable(R.drawable.ease_record_animate_08e),
                getResources().getDrawable(R.drawable.ease_record_animate_09e),
                getResources().getDrawable(R.drawable.ease_record_animate_10e),
                getResources().getDrawable(R.drawable.ease_record_animate_11e),
                getResources().getDrawable(R.drawable.ease_record_animate_12e),
                getResources().getDrawable(R.drawable.ease_record_animate_13e),
                getResources().getDrawable(R.drawable.ease_record_animate_14e), };
