...
import com.yangshao.banner.BannerAdapter;
import com.yangshao.banner.BannerView;
...
public class FootFragment extends BaseMvpFragment<HomePresenter> implements IHomeView {
    @BindView(R.id.id_bannerview)
    ...
    protected View loadViewLayout(LayoutInflater inflater, ViewGroup viewGrop) {
        return inflater.inflate(R.layout.fragment_foot, null);
    }
    ...
    private void initBanner() {
        bannerView.setBannerAdapter(new BannerAdapter() {
            ...
            public View getView(int position, View converView) {
                ...
                Glide.with(getActivity()).load(AppUrl.Http + advertisements.get(position).getImage_filename()).into((ImageView) converView);
                return converView;
            }
    ...
    public void onDestroyView() {
        bannerView.onDesotryBannerLoop();
        super.onDestroyView();
