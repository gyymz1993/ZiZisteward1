...
import static com.yangsho.baselib.R.id.iv_left;
import static com.yangsho.baselib.R.id.iv_right;
import static com.yangsho.baselib.R.id.title_bar;
import static com.yangsho.baselib.R.id.title_tv;
import static com.yangsho.baselib.R.id.tv_left;
import static com.yangsho.baselib.R.id.tv_right;
...
public class NavigationBarView extends RelativeLayout {
    ...
    public void setTitleText(String text) {
        TextView textView = viewFindById(title_tv);
    ...
    public void setLeftText(CharSequence text) {
        TextView textView = viewFindById(tv_left);
        if (textView != null && text != null) {
            textView.setText(text);
        }
    }
    ...
    public void setRightText(CharSequence text) {
        TextView textView = viewFindById(tv_right);
        if (textView != null && text != null) {
            textView.setText(text);
        }
    }
    ...
    public void setBackgroundColor(int color) {
        View view = viewFindById(title_bar);
    ...
    public void setLeftTextColor(int color) {
        TextView view = viewFindById(tv_left);
        if (view != null && color != 0) {
    ...
    public void setRightTextColor(int color) {
        TextView view = viewFindById(tv_right);
        if (view != null && color != 0) {
            view.setTextColor(color);
        }
    }
    ...
    public void setLetfIocnOnClickListener(View.OnClickListener listener) {
        View view = viewFindById(iv_left);
        if (view != null) {
    ...
    public void setLetfTextOnClickListener(View.OnClickListener listener) {
        View view = viewFindById(tv_left);
        if (view != null) {
            view.setOnClickListener(listener);
        }
    }
    ...
    public void setleftImageResource(Drawable resourceId) {
        ImageView imageView = viewFindById(iv_left);
        if (imageView != null) {
    ...
    public void setRightImageResource(Drawable resourceId) {
        ImageView imageView = viewFindById(iv_right);
        if (imageView != null) {
            imageView.setImageDrawable(resourceId);
        }
    }
