...
public class EventListener implements OnClickListener, OnLongClickListener, OnItemClickListener, OnItemSelectedListener, OnItemLongClickListener {
	...
	public static Object invokeClickMethod(Object handler, String methodName, Object... params) {
		...
		for (; clazz != Object.class; clazz = clazz.getSuperclass()) {
			/*
			 * try { method = clazz.getDeclaredMethod(methodName, View.class);
			 * method.setAccessible(true); // method =
			 * clazz.getMethod(methodName, View.class); if (method != null)
			 * return method.invoke(handler, params); } catch (Exception e) {
			 * e.printStackTrace(); }
			 */
		...
		if (method != null) {
			try {
				...
				return method.invoke(handler, params);
					...
					invokeBase(handler, method, null);
				}
			} catch (Exception e) {
				e.printStackTrace();
				System.err.println("点击方法执行失败");
	...
	public static boolean invokeLongClickMethod(Object handler, String methodName, Object... params) {
		...
		try {
			...
			} else throw new RuntimeException("no such method:" + methodName);
		} catch (Exception e) {
			// e.printStackTrace();
		}
	 ...
	 * @param method
	 */
	public static Object invokeBase(Object handler, Method method, Exception e) {
		if (method != null) {
			try {
